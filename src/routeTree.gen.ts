...
export interface FileRouteTypes {
  ...
  fullPaths: '/' | '/about' | '/contact' | '/popular' | '/categories/$categoryId' | '/authors' | '/categories';
  fileRoutesByTo: FileRoutesByTo;
  to: '/' | '/about' | '/contact' | '/popular' | '/categories/$categoryId' | '/authors' | '/categories';
  id: '__root__' | '/' | '/about' | '/contact' | '/popular' | '/categories/$categoryId' | '/authors/' | '/categories/';
